...
return array (
  ...
  'licence_info_description' => 'Tuvens is licenced under the <b><a target="_blank" href="https://tldrlegal.com/license/attribution-assurance-license-(aal)#summary">Attribution Assurance Licence (AAL)</a></b>. This licence requires the <b>\'Powered By Tuvens\'</b> notice to be kept in place on any Tuvens installation. If you wish to remove references to Tuvens you must purchase one of the white-label licences</b>.',
  ...
  'open_source_soft_description' => 'Tuvens is built using many fantastic open-source libraries.</b>.',
  'payment' => 'Payment',
  ...
  'version_out_of_date' => 'Your version (<b>:installed</b>) of Tuvens is out of date. The latest version (<b>:latest</b>) can be <a href=":url" target="_blank">downloaded here</a>',
  'version_up_to_date' => 'Your Tuvens version (<b>:installed</b>) is up to date!',
